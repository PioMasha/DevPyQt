...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonTextEdit.clicked.connect(self.onPushButtonLineEditClicked)
...
# TODO Самостоятельная реализация слотов для сигналов
    ...
    def onComboBoxCurrentTextChanged(self, text) -> None:
        self.plainTextEditLog.setPlainText(text)

    def onSpinBoxValueChanged(self, value) -> None:
        self.plainTextEditLog.setPlainText(str(value))

    def onDateTimeEditDateTimeChanged(self, dateTime) -> None:
        self.plainTextEditLog.setPlainText(dateTime.toString())
